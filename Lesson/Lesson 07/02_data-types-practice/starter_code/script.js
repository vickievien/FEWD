...
// console.log(number++);
console.log(number + " + " + number + " is " + ++number);
// console.log(++number);
// console.log(number++);
...
console.log("programmingIsCool is a type of " + typeof programmingIsCool);
console.log("clearancePrice is a type of " + typeof clearancePrice);
console.log("lifeTheUniverseAndEverything is a type of " + typeof lifeTheUniverseAndEverything);
console.log("theCruelestMonth is a type of " + typeof theCruelestMonth);