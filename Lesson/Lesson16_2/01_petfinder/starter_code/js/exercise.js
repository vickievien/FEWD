function selectPet(petType){
    ...
    function changeBig () {
        ...
        // document.querySelectorAll(".photoHaus .photoLarge").setAttribute("alt", this.getAttribute("alt"));
        
        document.querySelector(".thumbHaus").innerHTML = `<a href="${this.getAttribute("img")}"><img src="${this.getAttribute("thumb")}" alt="${this.getAttrbute("alt")}" class="photoLarge"></a>`
    };
